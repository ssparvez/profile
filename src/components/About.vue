    ...
    <div class="md-layout md-alignment-center-center">
      <div class="md-layout-item">
          <div id="bio">
            ...
            Proficient in <strong>Java</strong>, <strong>JavaScript</strong>, <strong>Python</strong>, and Klingon <br />
            Experience with <strong>React</strong>, <strong>Angular</strong> <strong>Node.js</strong> and <strong>Spring Boot</strong> <br/><br/>
            - Also - <br/><br/>
